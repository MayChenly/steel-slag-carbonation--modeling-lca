...
MW_CaOH2 = 74.1;
MW_CaO = 56.08;
MCao = 0.4752*0.5113; % Tian et al paper, 0.5113 is reactive CaO fraction

Mr = 0.7857; % Molar mass ratio of CO2 to CaO (no unit)

initial_residence_time = 0.000175; % Hours
Q_feed = V / (initial_residence_time * 3600);          % Flow rate of CO2, m^3/s

% Set up the steel slag characteristics
SS_density = 3.66 * 10^3;                              % Steel slag density, kg/m^3
...
% 文件名
filename = 'EAF_CO2_captured_data.xlsx';
...
% 参数定义
W_i = 0.0135;        %  kWh/kg
D_sm = 0.0095;        % initial particle size, m 
