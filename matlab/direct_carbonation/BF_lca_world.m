...
for i = 1:height(country_data)
    ...
    LCA2 = table(Country_col, repmat(CO2_stored_tonneBF,n,1), ...
    ...
    LCA4 = table(Country_col, repmat(CO2_stored_tonneBF,n,1), ...
    ...
    LCA6 = table(Country_col, repmat(CO2_stored_tonneBF,n,1), ...
        repmat(o1_E_DAC * input_ratio,n,1), repmat(E_liquefaction*input_ratio,n,1), repmat(E_vaporisation*input_ratio,n,1), ...
    ...
    LCA8 = table(Country_col, repmat(CO2_stored_tonneBF,n,1), ...
        repmat(o2_E_DAC * input_ratio,n,1), repmat(E_liquefaction*input_ratio,n,1), repmat(E_vaporisation*input_ratio,n,1), ...
...
% ==== 写入 Excel ====
output_filename = 'BF_LCA_all_countries.xlsx';
