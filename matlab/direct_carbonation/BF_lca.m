...
BF_mass = data.('SS_total_mass_kg'); %kg
...
% dissel+DAC option1
conversion_ratio  = 1000 / BF_mass ;  % conversion BF mass in chamber to 1 tonne
...
CO2_stored_tonneBF = CO2_total_stored *conversion_ratio;
...
LCA12 = table(scenario',CO2_stored_tonneBF',o1_E_DAC * input_ratio',E_liquefaction*input_ratio',E_vaporisation*input_ratio',E_crushing',E_fan',E_escape',o1_R_DAC * (-1)', ...
...
LCA14 = table(scenario',CO2_stored_tonneBF',o2_E_DAC*input_ratio',E_liquefaction*input_ratio',E_vaporisation*input_ratio',E_crushing',E_fan',E_escape',o2_R_DAC * (-1)', ...
    'VariableNames', {'Scenario','CO2 stored (kg)','DAC process(kg)','liquefaction (kg)','vaporisation (kg)','Crushing (kg)','Fan (kg)','CO2 escape (kg)','CO2 removal from air'});
...
LCA16 = table(scenario',CO2_stored_tonneBF',o1_E_DAC * input_ratio',E_liquefaction*input_ratio',E_vaporisation*input_ratio',E_crushing',E_fan',E_escape',e1_R_DAC * (-1)', ...
    'VariableNames', {'Scenario','CO2 stored (kg)','DAC process(kg)','liquefaction (kg)','vaporisation (kg)','Crushing (kg)','Fan (kg)','CO2 escape (kg)','CO2 removal from air'});
...
LCA18 = table(scenario',CO2_stored_tonneBF',o2_E_DAC * input_ratio',E_liquefaction*input_ratio',E_vaporisation*input_ratio',E_crushing',E_fan',E_escape',e2_R_DAC * (-1)', ...
    'VariableNames', {'Scenario','CO2 stored (kg)','DAC process(kg)','liquefaction (kg)','vaporisation (kg)','Crushing (kg)','Fan (kg)','CO2 escape (kg)','CO2 removal from air'});
LCA18_expanded = repmat(LCA18, height(LCA17), 1);
LCA4 = [LCA18_expanded,LCA17];


output_filename = 'BF_LCA_results.xlsx';
