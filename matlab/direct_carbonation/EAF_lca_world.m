...
for i = 1:height(country_data)
    ...
    EAF_mass = data.('SS_total_mass_kg');
    ...
    % ==== DAC variables ====
    conversion_ratio = 1000 / EAF_mass;
    ...
    CO2_stored_tonneEAF = CO2_total_stored * conversion_ratio;
    ...
    LCA2 = table(Country_col, repmat(CO2_stored_tonneEAF,n,1), ...
    ...
    LCA4 = table(Country_col, repmat(CO2_stored_tonneEAF,n,1), ...
    ...
    LCA6 = table(Country_col, repmat(CO2_stored_tonneEAF,n,1), ...
        repmat(o1_E_DAC * input_ratio,n,1), repmat(E_liquefaction*input_ratio,n,1), repmat(E_vaporisation*input_ratio,n,1), ...
    ...
    LCA8 = table(Country_col, repmat(CO2_stored_tonneEAF,n,1), ...
        repmat(o2_E_DAC * input_ratio,n,1), repmat(E_liquefaction*input_ratio,n,1), repmat(E_vaporisation*input_ratio,n,1), ...
...
% ==== 写入 Excel ====
output_filename = 'EAF_LCA_all_countries.xlsx';
