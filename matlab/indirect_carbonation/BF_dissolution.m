...
xCa = 0.2747;           % weight fraction of Ca in slag
xFe= 0.0027*0.6;       % weight fraction (soluble) Fe in the slag-is 60% of total
xMg = 0.0638;           % Weight fraction of Mg in the slag
rho = 2880;             % density of slag kg/m3
...
output_data = table(m/1000,20, Ca_at_20min, ...
    'VariableNames', {'BF_steel_slag_kg','Time_min', 'Ca_Concentration_mol_per_L'});
writetable(output_data, 'BF_Indirect_dissolution_result.xlsx');
