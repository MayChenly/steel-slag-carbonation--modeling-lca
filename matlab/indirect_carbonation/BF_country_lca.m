...
EF_table = readtable('C:\Users\Liyuan Chen\Desktop\indirect\results\LCApart\BF\country_information.xlsx');
...
BF_D_sm = 0.0025;
dp = 1e-5;
E_crushing = 0.01 * W_i .* (1 ./ sqrt(dp) - 1 ./ sqrt(BF_D_sm)) .* BF_steel_slag_kg;
...
%% === 写入 Excel ===
filename = 'BF_energy_output_by_country.xlsx';
