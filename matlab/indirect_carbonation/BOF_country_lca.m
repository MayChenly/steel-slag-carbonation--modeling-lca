...
%% === 读取主数据 ===
T = readtable('C:\Users\Liyuan Chen\Desktop\indirect\results\LCApart\BOF\BOF_Indirect_dissolution_result.xlsx');
colNames = T.Properties.VariableNames;

BOF_steel_slag_kg = T.(colNames{1});
...
EF_table = readtable('C:\Users\Liyuan Chen\Desktop\indirect\results\LCApart\BOF\country_information.xlsx');
...
BOF_D_sm = 0.0025;
dp = 1e-5;
E_crushing = 0.01 * W_i .* (1 ./ sqrt(dp) - 1 ./ sqrt(BOF_D_sm)) .* BOF_steel_slag_kg;
...
conversion_ratio = 1000/ BOF_steel_slag_kg;
...
%% === 写入 Excel ===
filename = 'BOF_energy_output_by_country.xlsx';
